...
# defines the model
model=ResNet50(num_classes=nb_classes)
model_name="ResNet50"
...
def run_SVHN(optimizer, optimizer_name, output_folder="../data", random_seed=None, display=True):
    """
    Runs a ResNet18 model on the SVHN dataset
    """
    ...
    # trains the model
    experiment = Experiment("SVHN", model_name, optimizer_name, output_folder)
